...
const TRANSLATIONS = {
    en: {
        ...
        enterKeyBeforeSaving: 'Enter a key before saving.',
        enterKeyBeforeTesting: 'Enter a key before testing.',
        ...
        creditsRemainingSuffix: 'credits remaining',
        nextReset: 'Next reset',
        resetsMonthly: 'Resets monthly',
        sharedProxyCopy: 'Shared proxy with model locks and monthly credits.',
        paidBypassesCopy: 'Paid tier bypasses the free credit pool for proxy requests.',
        bringYourOwnKeys: 'Bring Your Own Keys',
        savedPersonalKeys: 'Saved personal keys prefer direct provider requests and bypass the shared free-tier credit pool.',
        developerSandbox: 'Developer Sandbox',
        useTheseControls: 'Local controls for validating tier changes, credit exhaustion, and reset behavior during development.',
        useTheseControlsCopy: 'Use these controls to verify the billing UI without a live checkout backend.',
        resetCredits: 'Reset Credits',
        spendCredits: 'Spend 5 Credits',
        setFree: 'Set Free',
        setPro: 'Set Pro',
        setMax: 'Set Max',
        creditsResetTo: 'Credits reset to',
        creditsReducedTo: 'Credits reduced to',
        planSetTo: 'Plan set to'
    },
